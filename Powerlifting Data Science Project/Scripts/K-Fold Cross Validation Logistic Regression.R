...
for (i in seq_along(folds_male)) {
  ...
  model_logistic_male <- glm(Podium ~ Equipment + WeightClassKg + Division + 
  ...
  predictions_male <- predict(model_logistic_male, newdata = test_data_male, type = "response")
...
for (i in seq_along(folds_female)) {
  ...
  model_logistic_female <- glm(Podium ~ Equipment + WeightClassKg + Division + 
                              Best3SquatKg + Best3BenchKg + Best3DeadliftKg +
                              SquatSpecialist + BenchSpecialist + DeadliftSpecialist + BalancedSpecialist +
                              WeightClassKg * Best3SquatKg + WeightClassKg * Best3BenchKg,
  ...
  predictions_female <- predict(model_logistic_female, newdata = test_data_female, type = "response")
